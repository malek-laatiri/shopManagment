    ...
    public ResultSet read() {
        ...
        Statement st = null;
            try {
                ...
                rs = st.executeQuery("select product_name,product_description,product_category,product_stock,product_price,product_img,category_name from product,category where product.product_category=category.category_id");
                return rs;
            } catch (Exception e) {
                System.out.println(e.getMessage());
